---
title: "Raster Analysis using R - Some social science applications"
categories:
  - Spatial Analysis
  - GIS
description: |
...
In this analysis, we use R to perform some demographically relevant analysis of raster data. The data come from the [2006 National Land Cover Database](https://www.mrlc.gov/nlcd06_data.php) and Landsat imagery.

First we reclassify the NLCD data into two classes, based on the value of the raster. In this case, I want to classify the pixels as to whether they are developed or undeveloped. 
...
Finally, we show how to use R to display landsat imagery and calculate the Normalized Differnce Vegitation Index, or NDVI. 
