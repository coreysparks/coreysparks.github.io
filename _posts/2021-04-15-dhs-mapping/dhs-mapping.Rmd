...
In this brief example, I show how to use the GPS coordinates from the [Demographic and Health Survey data](https://dhsprogram.com/) and merge them to the ADM2 subnational geographic level for the country of Ethopia. Then I produce estimates using the DHS data for ADM 2 regions of the country.
