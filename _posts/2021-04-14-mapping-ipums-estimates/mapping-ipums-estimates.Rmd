---
title: "Using [IPUMS USA](https://usa.ipums.org/usa/) for Estimation of Population Characteristics in Various Geographic Areas"
categories:
  - Spatial Analysis
  - Survey data
  - Census data
description: |
  In this example we will use the IPUMS USA data to produce survey-based estimates for various geographic levels present in the IPUMS.
author:
